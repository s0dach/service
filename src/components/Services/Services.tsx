...
const services: Service[] = [
  {
    ...
    description: 'Профессиональный ремонт и обслуживание тормозной системы автомобиля',
    price: 'от 3 500 ₽',
  ...
  },
  {
    ...
    description: 'Диагностика и ремонт системы рулевого управления',
    price: 'от 3 000 ₽',
  ...
  },
  {
    ...
    description: 'Обслуживание и ремонт системы охлаждения двигателя',
    price: 'от 2 500 ₽',
  ...
  },
  {
    ...
    description: 'Диагностика и ремонт топливной системы автомобиля',
    price: 'от 3 500 ₽',
  ...
  },
  {
    ...
    description: 'Профессиональный ремонт коробки передач и трансмиссии',
    price: 'от 15 000 ₽',
  ...
  },
  {
    ...
    description: 'Ремонт и обслуживание ходовой части автомобиля',
    price: 'от 5 000 ₽',
    ...
    <section id="services" className="services section-padding">
      <div className="container">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="heading-lg">УСЛУГИ РЕМОНТА</h2>
          <p className="text-lg services__subtitle">
            Профессиональный ремонт и техническое обслуживание автомобилей всех марок
          </p>
        </motion.div>
