...
const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Ремонт системы охлаждения двигателя в Чебоксарах. Замена радиатора, помпы, термостата',
    price: 'от 2 500 ₽',
    features: ['Замена радиатора', 'Ремонт помпы', 'Замена термостата', 'Промывка системы'],
    image: Ohlajdenie
  },
  {
    id: 6,
  ...
  },
  {
    ...
    description: 'Ремонт коробки передач в Чебоксарах. МКПП, АКПП, замена сцепления, диагностика КПП',
    price: 'от 15 000 ₽',
    features: ['Ремонт МКПП', 'Ремонт АКПП', 'Замена сцепления', 'Диагностика трансмиссии'],
    image: Hodovka
  },
  {
    id: 8,
  ...
  },
  {
    ...
    description: 'ТО автомобиля в Чебоксарах. Замена масла, фильтров, диагностика систем, профилактика',
    price: 'от 4 000 ₽',
  ...
  },
  {
    ...
    description: 'Ремонт двигателя в Чебоксарах. Капитальный ремонт, замена деталей, диагностика мотора',
    price: 'от 20 000 ₽',
    features: ['Капитальный ремонт', 'Замена поршневой группы', 'Ремонт ГБЦ', 'Настройка систем'],
    image: Dvigatel
  }
];
    ...
    <section id="services" className="services section-padding">
      <div className="container">
        ...
        >
          ...
          <p className="text-lg services__subtitle">
            Профессиональный ремонт и техническое обслуживание автомобилей всех марок в автосервисе Центр Авто. 
            Диагностика, ремонт двигателя, тормозов, ходовой части. Гарантия качества, оригинальные запчасти.
          </p>
        </motion.div>
