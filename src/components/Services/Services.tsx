      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-lg services__subtitle">
            Автосервис Чебоксары: ремонт двигателя, замена ГРМ, ремонт коробки, замена помпы, термостата, радиатора. 
            Шиномонтаж на Чернышевского. Промывка печки и радиатора. Эльменя, Энтузиастов, Финская долина, Чапаевский посёлок. 
            Гарантия качества, оригинальные запчасти.
          </p>
        </motion.div>
